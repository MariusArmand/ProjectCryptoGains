...
CREATE TABLE TB_ASSET_CODES_KRAKEN (
    CODE   VARCHAR(20) NOT NULL,
    ASSET  VARCHAR(50) NOT NULL
);
...
CREATE UNIQUE INDEX UIX_ASSET_CATALOG_CODE_NOCASE ON TB_ASSET_CATALOG COMPUTED BY (UPPER(CODE));
CREATE UNIQUE INDEX UIX_ASSET_CODES_KRAKEN_CODE_NOCASE ON TB_ASSET_CODES_KRAKEN COMPUTED BY (UPPER(CODE));
CREATE UNIQUE INDEX UIX_EXCHANGE_RATES_COMB ON TB_EXCHANGE_RATES ("DATE", CURRENCY, FIAT_CURRENCY, EXCHANGE_RATE);
CREATE INDEX IX_LEDGERS_CURRENCY ON TB_LEDGERS (CURRENCY);
...
INSERT INTO TB_ASSET_CATALOG (CODE, ASSET) VALUES ('EUR', 'EUR');
INSERT INTO TB_ASSET_CATALOG (CODE, ASSET) VALUES ('BTC', 'BTC (Bitcoin)');

INSERT INTO TB_ASSET_CODES_KRAKEN (CODE, ASSET) VALUES ('EUR', 'EUR');
INSERT INTO TB_ASSET_CODES_KRAKEN (CODE, ASSET) VALUES ('BTC', 'BTC (Bitcoin)');